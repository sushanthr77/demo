...
func (t *SimpleChaincode) create_trade(stub shim.ChaincodeStubInterface, caller string, caller_affiliation string, trade_json []byte) ([]byte, error) {
	...
	err := json.Unmarshal(trade_json, &trade) // Convert the JSON defined above into a vehicle object for go
	...
	if trade.TradeId == "" || trade.Description == "" || (trade.CreateDTTM == time.Time{}) || trade.ExtRefNum == "" {
		logger.Debug(trade.TradeId + trade.Description + trade.CreateDTTM.String() + trade.ExtRefNum)
...
func main() {
	...
	//	pl := ""
	//
	//	arg0, err := base64.StdEncoding.DecodeString(pl)
	...
	//	}
	//
	//	arg0, err = base64.RawStdEncoding.DecodeString(pl)
	//	os.Stdout.Write(arg0)
	//
	//	if err != nil {
	//		fmt.Printf("\nError2 : %s", err)
	//	}
	//
	//	arg0, err = base64.RawURLEncoding.DecodeString(pl)
	//	os.Stdout.Write(arg0)
	//
	//	if err != nil {
	//		fmt.Printf("\nError3 : %s", err)
