...
func (t *SimpleChaincode) create_participant(stub shim.ChaincodeStubInterface, caller string, caller_affiliation string,
	...
	if err != nil {
		return nil, errors.New("Invalid JSON object provided for create_participant = " + participant_json + " = " + partyType)
	}
	...
	_, err = t.save_participant(stub, []byte(participant_json), participant.getId())
...
func main() {
	...
	//	pl := ""
	//
